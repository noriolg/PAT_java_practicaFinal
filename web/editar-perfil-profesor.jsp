...
<div class = "contenido">
    ...
    <div class="display-info">
        ...
        <div class ="datos-display" >
            <c:forEach var = "row" items = "${result.rows}">
                ...
                <div class = "info-piece">
                    <div class = "indicador">Descripcion:</div><br><label id="etapa_label" name="etapa_label"  class="form-control " >${row.descripcion}</label>
                </div>
            </c:forEach>
        </div>
    </div>
    ...
    <div class="formulario">
        ...
        <div class = "aclaracion">Introduce aquí solo los datos que quieras cambiar, lo demás lo puedes dejar en blanco.</div>
        <form method="post" action="EditarPerfil" onsubmit="return validarFormularioEdicionProfesor()">
            <div class="row">
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <input id="descripcion" name="descripcion" type="text"  placeholder="Descripción" class="form-control " autofocus="">
                    </div>
                </div>
            </div>
            ...
            <input id="submitActualizacionProfesor" name = "submitActualizacionProfesor" class="submit btn btn-primary" type="submit" value = "Actualizar">
        </form>
    </div>
