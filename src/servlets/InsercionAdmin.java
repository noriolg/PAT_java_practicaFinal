        ...
        try
        {
            if(submitProfesor != null)
            {
                ...
                if(insertarProfesor(profesor)){
                    ...
                    request.setAttribute("mensajeActualizacionProfesor", "Profesor añadido correctamente");
                }
                else{
                    request.setAttribute("mensajeActualizacionProfesor", "Nombre de usuario ya existe");
                }
            }
            else if(submitAsignatura != null)
            {
                ...
                if(insertarClaseProducto(claseProducto)){
                    ...
                    request.setAttribute("mensajeActualizacionAsignatura", "Clase añadida correctamente");
                }
                else{
                    // Esto nunca va a pasar porque la primary key es autogenerated.
                    request.setAttribute("mensajeActualizacionAsignatura", "Ya existe la clase");
                }
            }
            else{
                // A la entrada de cualquier insercion se pasa por aquí para borrar
                // un posible mensaje que haya en la sesión de alguna actualización pasada.
                if(request.getAttribute("mensajeActualizacionProfesor") != null){
                    request.removeAttribute("mensajeActualizacionProfesor");
                }
                if(request.getAttribute("mensajeActualizacionAsignatura") != null){
                    request.removeAttribute("mensajeActualizacionAsignatura");
                }
            }
            request.getRequestDispatcher("/anadir").forward(request, response);
        }
        catch(Exception e)
        {
